# Fix for AttributeError: 'FileSearchApp' object has no attribute 'dir_input'
# search_files.py no longer has dir_input, so we remove references to it in ui_main_window
...
from search_files import FileSearchApp
...
class MainWindow(QMainWindow):
    ...
    def load_main_tabs(self):
        ...
        # Updated: pass pbip path directly
